...
exports.WorkflowsModule = WorkflowsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [workflows_service_1.WorkflowsService, workflow_execution_service_1.WorkflowExecutionService, prisma_service_1.PrismaService, notifications_service_1.NotificationsService],
        exports: [workflow_execution_service_1.WorkflowExecutionService],
    })
], WorkflowsModule);
