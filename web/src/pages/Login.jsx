...
export default function Login() {
  ...
  return (
    <div className="space-y-4 px-4 sm:px-40 flex flex-col items-center flex-1 justify-center py-5">
      <div className="flex flex-col w-full max-w-[400px] border border-[#3d5245] rounded-2xl p-8 mx-auto bg-[#1c2420]">
        <h2 className="text-white tracking-light text-[28px] font-bold leading-tight text-center pb-3 pt-5">Log in</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button className="bg-[#38e07b] text-[#111714] h-10 rounded-full px-4 w-full text-sm font-bold" type="submit">Log in</button>
        </form>
      </div>
      <p className="text-[#9eb7a8] text-sm text-center">By logging in, you agree to our Terms of Service and Privacy Policy.</p>
