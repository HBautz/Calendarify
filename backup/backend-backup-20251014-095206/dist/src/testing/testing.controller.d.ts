...
export declare class TestingController {
    ...
    updateAvailability(req: any, body: any): Promise<{
        error: string;
        example: {
            day: string;
            start_time: string;
    ...
    updateUserState(req: any, body: any): Promise<{
        error: string;
        example: {
            key: string;
            value: {
    ...
    testTimezone(req: any, body: any): Promise<{
        error: string;
        example: {
            local_time: string;
