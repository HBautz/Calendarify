...
function parseICalEvent(ical) {
    var _a, _b, _c;
    const summary = (_a = ical.match(/SUMMARY:(.*)/)) === null || _a === void 0 ? void 0 : _a[1];
    const dtstart = (_b = ical.match(/DTSTART[^:]*:(.*)/)) === null || _b === void 0 ? void 0 : _b[1];
    const dtend = (_c = ical.match(/DTEND[^:]*:(.*)/)) === null || _c === void 0 ? void 0 : _c[1];
